...
def main(args):
    ...
    print(f"Using differential learning rate. Backbone LR: {args.lr * 0.1}, Head LR: {args.lr}")
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if epoch > 0 and epoch <= 40 and epoch % 1 == 0:
            ...
            # write into txt
            val_info = re.sub(r'mean IoU:\s*([0-9.]+)', 
                  lambda m: f"mean IoU: {float(m.group(1)):.2f}", 
                  val_info)
